...
class CopyableWidget extends StatelessWidget {
  const CopyableWidget({super.key, required this.text, this.copyableContent});
  ...
  Future<void> onTap(BuildContext context) async {
    try {
      ...
      ToastService.show(context: context, 'Đã copy ${copyableContent ?? text}', type: ToastType.info);
